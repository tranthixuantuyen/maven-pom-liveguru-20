...
public class UserRegisterPageUI {
	...
	public static final String DAY_DROP_DOWN = "xpath=//select[@name='DateOfBirthDay']";
	public static final String MONTH_DROP_DOWN = "xpath=//select[@name='DateOfBirthMonth']";
	public static final String YEAR_DROP_DOWN = "xpath=//select[@name='DateOfBirthYear']";
